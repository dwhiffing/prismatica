...
export const ENTITIES: Record<EType, Entity> = {
  S: { name: 'solar', splines: [
    sp([[10, 2], [10, 5], [8.5, 8.5], [6.5, 11], [3.5, 12.5]], 10, '#c342ff'),
    sp([[11.5, 0], [11, 2], [10, 2]], 10, '#A9A98B'),
    sp([[3.5, 12.5], [3.5, 13.5], [1.5, 14.5], [0, 14.5]], 10, '#A9A98B'),
  ] },
  L: { name: 'link', splines: [
    sp([[0, 1], [3, 7], [0, 14]], 12, '#fcff42', [0, 0, 0], [0, 0, 0], 1, 0.63, 1),
  ] },
  M: { name: 'miner', splines: [
    sp([[2.5, 11.5], [2, 16], [0, 18]], 8, '#4f8'),
    sp([[2.5, 0], [2, 12.5], [0, 14.5]], 8, '#d1d3ca', [3, 0, 0]),
    sp([[2.5, 0], [2, 12.5], [0, 14.5]], 8, '#d1d3ca', [0, 0, 3]),
    sp([[2.5, 0], [2, 12.5], [0, 14.5]], 8, '#d1d3ca', [0, 0, -3]),
    sp([[2.5, 0], [2, 12.5], [0, 14.5]], 10, '#d1d3ca', [-3, 0, 0]),
  ] },
  T: { name: 'tower', splines: [
    sp([[0, 0], [6, 0], [2, 8], [2, 22], [0, 22]], 4, '#66bdff'),
  ] },
  ...
  E: { name: 'enemy', splines: [
    sp([[4, 12], [0, 14]], 16, '#ff243a', [0, -2, 0]),
    sp([[5, 11], [4, 12]], 16, '#560101', [0, -2, 0]),
    sp([[0, 5], [8, 9.5], [5, 11]], 16, '#ff243a', [0, -2, 0]),
  ] },
}
