...
export const COST: Record<BType, number> = { S: 60, L: 3, M: 12, T: 25 } // resource cost to place
export const BUILD: Record<BType, number> = { S: 30, L: 2, M: 8, T: 15 } // energy to construct
