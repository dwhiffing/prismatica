...
export const S = {
  ...
  parts: [] as [number, number, number, number, number, string, number?, number?][],
  resource: 0,
...
export const LT = {
  dayLen: 100, // full cycle at UNIFORM rate; day is stretched 3x (see the dayT advance in game.ts)
  dayT: 0.35,
